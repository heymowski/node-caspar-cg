...
module.exports = function (ccg) {
	...
	// ccg.cgInvokeMethod
	// ---
	// Invoke a method on a template
	//
	// CG [video_channel:int]{-[layer:int]|-9999} INVOKE [cg_layer:int] [method:string]
	
	ccg.prototype.cgInvokeMethod = function (video_channel, video_layer, cg_layer, method, cb) {
		...
		let cmd = "CG " + videoChannelAndLayer + " INVOKE " + cg_layer + " " + method;
